package cn.wewin.backend.modules.monitor.config;

import cn.wewin.backend.modules.monitor.domain.LogMessage;
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        if(log!=null){
                            // 格式化异常堆栈信息
                            if("ERROR".equals(log.getLevel()) && "cn.wewin.common.exception.handler.GlobalExceptionHandler".equals(log.getClassName())){
